"""Panel visualizations: cohort divergence in fossil generation under carbon pricing.

These charts are descriptive and associational. They show how fossil generation
trajectories differ across 2010 emission-intensity cohorts alongside the rising
EU ETS carbon price; they do not by themselves establish causation.
"""
...
def generate_cohort_charts():
    """Process panel data and generate cohort-divergence visualizations."""
    print("Generating panel cohort visualizations...")
    ...
    ax1.set_title("Fossil Generation by Grid Cohort, Alongside the Rising Carbon Price", fontsize=16, fontweight="bold")
    ...
    plt.tight_layout()
    plt.savefig("charts/cohort_timeline_divergence.png", dpi=300)
    plt.close()
    print("[OK] Cohort timeline saved to charts/cohort_timeline_divergence.png")
    ...
    plt.title("Fossil Generation vs. Carbon Price, by Grid Type (Association)", fontsize=14, fontweight="bold")
    ...
    plt.tight_layout()
    plt.savefig("charts/cohort_slope_interaction.png", dpi=300)
    plt.close()
    print("[OK] Cohort slope chart saved to charts/cohort_slope_interaction.png")


if __name__ == "__main__":
    setup_directories()
    generate_cohort_charts()